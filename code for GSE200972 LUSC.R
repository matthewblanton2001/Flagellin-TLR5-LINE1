library(tidyverse)
library(Seurat)
expression_matrix<-ReadMtx(mtx="GSM6047623_P1_T_R_I_matrix.mtx.gz",features="GSM6047623_P1_T_R_I_features.tsv.gz",cells="GSM6047623_P1_T_R_I_barcodes.tsv.gz")
seurat_object<-CreateSeuratObject(expression_matrix)
expression_matrix<-ReadMtx(mtx="GSM6047625_P1_T_R_M_matrix.mtx.gz",features="GSM6047625_P1_T_R_M_features.tsv.gz",cells="GSM6047625_P1_T_R_M_barcodes.tsv.gz")
...
new_ids<-c("0"="CD4 T","1"="Macrophage","2"="CD8 T","3"="CD4 T","4"="Mast Cells","5"="Mast Cells","6"="CD4 T","7"="Epithelial","8"="B","9"="Mast Cells","10"="Epithelial","11"="CD8 T","12"="Exhausted T","13"="Epithelial","14"="DC","15"="Plasma Cells","16"="Epithelial","17"="Fibroblast")
combined_seurat<-RenameIdents(combined_seurat,new_ids)
combined_seurat$celltype<-Idents(combined_seurat)
major_cols<-c("CD4 T"="red3","Epithelial"="forestgreen","CD8 T"="red","Fibroblast"="orange","B"="green","DC"="violet","Macrophage"="deepskyblue","Plasma Cells"="yellow2","Mast Cells"="purple","Exhausted T"="gold1")
library(ggrepel)
