library(tidyverse)
library(Seurat)
expression_matrix<-ReadMtx(mtx="GSM6047627_P2_T_R_I_matrix.mtx.gz",features="GSM6047627_P2_T_R_I_features.tsv.gz",cells="GSM6047627_P2_T_R_I_barcodes.tsv.gz")
seurat_object<-CreateSeuratObject(expression_matrix)
expression_matrix<-ReadMtx(mtx="GSM6047629_P2_T_R_M_matrix.mtx.gz",features="GSM6047629_P2_T_R_M_features.tsv.gz",cells="GSM6047629_P2_T_R_M_barcodes.tsv.gz")
...
new_ids<-c("0"="CD4 T","1"="CD4 T","2"="Epithelial","3"="Epithelial","4"="CD8 T","5"="B","6"="Monocyte","7"="Treg","8"="Macrophage","9"="DC","10"="Fibroblast","11"="Endothelial","12"="Mast Cells","13"="NK","14"="Plasma Cells","15"="Epithelial","16"="Exhausted T","17"="Neutrophil")
major_cols<-c("CD4 T"="red3","Epithelial"="forestgreen","CD8 T"="red","Fibroblast"="orange","B"="green","DC"="violet","Macrophage"="deepskyblue","Plasma Cells"="yellow2","Mast Cells"="purple","Exhausted T"="gold","NK"="dodgerblue","Treg"="olivedrab2","Endothelial"="magenta1","Neutrophil"="orangered1","Monocyte"="darkorange2")
