library(tidyverse)
library(Seurat)
expression_matrix<-ReadMtx(mtx="GSM6047624_P1_N_R_I_matrix.mtx.gz",features="GSM6047624_P1_N_R_I_features.tsv.gz",cells="GSM6047624_P1_N_R_I_barcodes.tsv.gz")
seurat_object<-CreateSeuratObject(expression_matrix)
expression_matrix<-ReadMtx(mtx="GSM6047626_P1_N_R_M_matrix.mtx.gz",features="GSM6047626_P1_N_R_M_features.tsv.gz",cells="GSM6047626_P1_N_R_M_barcodes.tsv.gz")
...
new_ids<-c("0"="CD4 T","1"="Epithelial","2"="Epithelial","3"="CD8 T","4"="NK","5"="CD4 T","6"="CD4 T","7"="Macrophage","8"="NK","9"="Monocyte","10"="Epithelial","11"="Fibroblast","12"="B","13"="Endothelial","14"="Plasma Cells","15"="Neutrophil","16"="NK","17"="Mast Cells","18"="Epithelial")
major_cols<-c("CD4 T"="red3","Epithelial"="forestgreen","CD8 T"="red","Fibroblast"="orange","B"="green","Macrophage"="deepskyblue","Plasma Cells"="yellow2","Mast Cells"="purple","NK"="dodgerblue","Endothelial"="magenta1","Neutrophil"="orangered1","Monocyte"="darkorange2")
